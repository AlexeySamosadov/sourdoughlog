/** Autonomous order fulfilment for SourdoughLog — GitHub Action on new issue.
...
comment(["✅ **Payment verified — your SourdoughLog Pro license:**", "", "Open SourdoughLog → **Pro** → *Have a key?* → paste:", "", "```", license, "```", "", "Lifetime, works offline. Happy baking 🍞"].join("\n"));
